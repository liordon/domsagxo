...
To compose routines and numbers means:
    ...
    afterwards while i ≤ the length of routines do:
        ...
        afterwards arguments = arguments + it
        afterwards i += 1.
    End.
...
To pretend means:
    ...
    afterwards assign it into first time
    afterwards Randomize time between 2100 and 2200
    afterwards assign it into second time
...
to sunrise means
    ...
    afterwards for brightness index between 1 and 100 do
